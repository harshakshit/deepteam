...
class SystemReconnaissance(BaseVulnerability):
    ...
    def __init__(
        ...
        types: Optional[List[SystemReconnaissanceLiteralType]] = [
            type.value for type in SystemReconnaissanceType
        ],
        purpose: Optional[str] = None,
    ):
        enum_types = validate_vulnerability_types(
            self.get_name(), types=types, allowed_type=SystemReconnaissanceType
        )
    ...
    def assess(
        ...
        purpose: Optional[str] = None,
    ) -> Dict[SystemReconnaissanceType, List[RTTestCase]]:
        ...
        results: Dict[SystemReconnaissanceType, List[RTTestCase]] = {}
        res: Dict[SystemReconnaissanceType, SystemReconnaissanceMetric] = {}
    ...
    def simulate_attacks(
        ...
        for type in self.types:
            ...
            templates[type].append(
                SystemReconnaissanceTemplate.generate_baseline_attacks(
    ...
    def _get_metric(
        self,
        type: SystemReconnaissanceType,
    ) -> BaseRedTeamingMetric:
        # Note: We will need to create SystemReconnaissanceMetric to match this call
        return SystemReconnaissanceMetric(
