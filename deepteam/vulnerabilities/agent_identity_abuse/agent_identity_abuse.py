...
class AgentIdentityAbuse(BaseVulnerability):
    ...
    def __init__(
        ...
        types: Optional[List[AgentIdentityAbuseLiteral]] = [
    ...
    def assess(
        ...
        purpose: Optional[str] = None,
    ) -> Dict[AgentIdentityAbuseType, List[RTTestCase]]:
        ...
        results: Dict[AgentIdentityAbuseType, List[RTTestCase]] = {}
        res: Dict[AgentIdentityAbuseType, AgentIdentityAbuseMetric] = {}
    ...
    def simulate_attacks(
        ...
        for type in self.types:
            ...
            templates[type].append(
                AgentIdentityAbuseTemplate.generate_baseline_attacks(
    ...
    def _get_metric(
        self,
        type: AgentIdentityAbuseType,
    ) -> BaseRedTeamingMetric:
        return AgentIdentityAbuseMetric(
            abuse_type=type.value,
